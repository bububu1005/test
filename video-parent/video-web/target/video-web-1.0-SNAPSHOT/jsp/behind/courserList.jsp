...
<head>
    ...
    <script type="text/javascript">
        function showAddPage() {
            location.href = "${pageContext.request.contextPath}/course/edit";
        }
        ...
        function delSpeakerById(Obj, id, name) {
            ...
            Confirm.show('温馨提示：', '确定要删除' + name + '么？', {
                'Delete': {
                    ...
                    'callback': function () {
                        var param = {"id": id};
                        $.post("${pageContext.request.contextPath}/course/courserDel", param, function (data) {
                            if (data == 'success') {
    ...
    <table class="table table-bordered table-hover"
        ...
        <c:forEach items="${page.rows}" var="course" varStatus="status">
            <tr>
                ...
                <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">${course.subject.subject_name}</td>
                ...
                <td><a onclick="return delSpeakerById(this,'${course.id}','${course.course_title}')"><span
