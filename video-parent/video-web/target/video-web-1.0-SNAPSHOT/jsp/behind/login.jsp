...
<head>
    ...
    <script>
        function validateLogin() {
            var admin = $("form").serialize();
            $.post(
                "${pageContext.request.contextPath}/video/login", admin, function (data) {
                    if (data == 'success') {
                        //alert("登录成功");
...
<body>
<form ><%--action="${pageContext.request.contextPath}/video/login" method="post"--%>
        ...
        <div class="container" style="margin-top: 10px;">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4" style=":1px solid #5CB85C">
                    ...
                    <input type="text" class="form-control" name="username" style="border:1px solid #5CB85C" value="admin"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="password" class="form-control" name="password" style="border:1px solid #5CB85C" value="123"
