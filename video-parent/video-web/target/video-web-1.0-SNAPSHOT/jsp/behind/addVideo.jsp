...
<head>
    ...
    <script type="text/javascript">
        ...
        //页面加载完毕之后就执行以下代码片段
        $(function () {
            var speakerId = '${video.speaker_id}';
            ...
            <div class="col-sm-10">
                <div class="input-group">
                    ...
                    <c:if test="${empty video.speaker_id}">
                        <input type="hidden" class="form-control" id="speakerId" name="speaker_id" value="0">
                    </c:if>
                    <c:if test="${not empty video.speaker_id}">
                        <input type="hidden" class="form-control" id="speakerId" name="speaker_id"
                               value="${video.speaker_id}">
                    </c:if>
