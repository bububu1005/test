...
<%@ page import="com.qf.videos.utils.StringUtils" %>
...
<nav class="w100">
    <div class="container">
        ...
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/jsp/before/index.jsp">首页</a>
            </li>
            <li class="nav_down">
                ...
                <div class="section">
                    ...
                    <ul>
                        ...
                        <c:forEach items="${course.videoList}" var="video" varStatus="i">
                            <li class="section-main" onclick="getVideo(${video.id},${video.course_id} ,${video.course_id})">
                                ...
                                <div class="classify-v-info">
                                    ...
                                    <span class="duration" title="视频时长"><img
                                            src="${pageContext.request.contextPath}/img/player.png" alt="">${video.times}</span>
                                </div>
                            </li>
...
<script type="text/javascript">
    ...
    function getVideo(videoId ,subjectName ,courseId) {
        //alert("${sessionScope.userAccount}");
        //判断用户是否登录
        //alert($("#isLogin").val());
        if ((null != "${sessionScope.userAccount}" && "${sessionScope.userAccount}" != "") || ($("#isLogin").val() == 1)) {
            //如果登录
            location.href = "${pageContext.request.contextPath}/video/showVideo?videoId=" + videoId + "&subjectName=" + '${subject.subject_name}' + "&courseId=" + courseId;
        } else {
            //如果不登录，弹登录框
