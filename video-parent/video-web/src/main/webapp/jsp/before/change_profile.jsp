        ...
        <menu>
            <div class="container clearfix">
                <ul class="clearfix f_left">
                    <li><a href="${pageContext.request.contextPath}/jsp/before/index.jsp">首页</a></li>
                ...
                <div id="user_bar">
                    <a href="${pageContext.request.contextPath}/user/showMyProfile">
                      ...
                      <c:if test="${not empty user.imgUrl}">
                         <img id="avatar" src="http://localhost:8081/images/${user.imgUrl}" alt="">
                      </c:if>
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <img width="180px" height="180px"  src="http://localhost:8081/images/${user.imgUrl}">
                        </div>
                        <div class="profile_ifo_area">
                            ...
                            <form action="${pageContext.request.contextPath}/user/updateUser" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <span >${user.email}</span><input type="hidden" name="email" value="${user.email}"/>
                                </div>
                                <div class="form_group">
