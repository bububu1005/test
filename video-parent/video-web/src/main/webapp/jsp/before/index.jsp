...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logo.png" alt="Y先生教育的logo"
             onclick="location.href='#'" draggable="false">
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/jsp/before/index.jsp" target="_blank">首页</a>
            </li>
            <li class="nav_down">
            ...
            <li id="gkk" class="nav_choose">
                <a href="${pageContext.request.contextPath}/course/section">在线公开课</a>
            </li>
            <li>
                <a href="#">专家师资</a>
            </li>
